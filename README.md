...
![Main setup](./images/setup.jpg?raw=true "Main setup")
...
![The front side of the glove with visible sensors and tracker target.](./images/glove_frontside.jpg?raw=true "The front side of the glove with visible sensors and tracker target.")
...
![Tracker is tracking this green circle to move the mouse.](./images/tracker_target.jpg?raw=true "Tracker is tracking this green circle to move the mouse.")
...
![Wires from the four fingers connected to the GPIO pins on the Dragonboard.](./images/gpio_connections.jpg?raw=true "Wires from the four fingers connected to the GPIO pins on the Dragonboard.")
